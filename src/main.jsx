...
function Chat({ messages: chatMessages, onSendMessage }) {
  ...
  return (
    <div className="flex min-h-full flex-col gap-4">
      ...
      <div className="flex items-center gap-2 rounded-3xl bg-white p-2 shadow-sm transition-shadow focus-within:ring-2 focus-within:ring-amber-500 focus-within:ring-offset-2">
...
function SearchBox({ value, onChange }) {
  return (
    <label className="flex h-14 items-center gap-3 rounded-3xl bg-white px-4 shadow-sm transition-shadow focus-within:ring-2 focus-within:ring-amber-500 focus-within:ring-offset-2">
