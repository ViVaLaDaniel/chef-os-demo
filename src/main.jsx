  ...
  return (
    <div className="flex min-h-full flex-col gap-4">
      ...
      <div className="flex items-center gap-2 rounded-3xl bg-white p-2 shadow-sm focus-within:ring-2 focus-within:ring-amber-500">
        ...
        <button onClick={sendMessage} className="grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-amber-500 text-white disabled:bg-slate-200 focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2" aria-label="Отправить" disabled={!draft.trim()}>
          <Send size={22} />
        </button>
      </div>
    </div>
