...
- [ ] Разработать компонент приветствия `IntroCarousel` со слайдами и точечными индикаторами
- [ ] Интегрировать приветствие в начало экрана Onboarding с сохранением состояния в `localStorage`
- [ ] Добавить в настройки кнопку ручного сброса состояния просмотра приветствия
